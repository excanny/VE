                ...
                <div class="box box-warning">
                    ...
                    <?php if($basic_info->process_level == 0){ ?>
                        <div class="box-footer">
                            <a href="<?php echo site_url('requisition/HodReject/'.$basic_info->req_ID);?>" class="btn btn-danger" onclick="return confirm('are you sure you want to reject this item?')">Reject</a>
                            <a href="<?php echo site_url('requisition/HodRecommend/'.$basic_info->req_ID);?>" class="btn btn-success pull-right" onclick="return confirm('are you sure you want to recommend this item?')">Recommend</a>
                        </div>
                    <?php } ?>
                    <!-- /.box-footer -->
                </div>
