            ...
            <div class="col-md-12">    
                ...
                <div class="box box-warning">
                    ...
                    <?php if($basic_info->process_level == 1){ ?>
                        <a href="<?php echo site_url('requisition/MDReject/'.$basic_info->req_ID);?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to reject this item?')">Reject</a>
                        <a href="<?php echo site_url('requisition/MDRecommend/'.$basic_info->req_ID);?>" class="btn btn-success pull-right" onclick="return confirm('Are you sure you want to approve this item?')">Approve</a>
                    <?php } ?>
                    </div>
                    <!-- /.box-footer -->
                </div>
