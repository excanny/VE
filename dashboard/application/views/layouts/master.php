  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-list-alt"></i> <span>Evaluation & Appraisal</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
          <?php if($user->isHOD == 0){ ?>
            <li><a href="<?php echo site_url();?>/performance"><i class="fa fa-circle-o"></i> Performance Evaluation</a></li>
          <?php } ?>
          <?php if($user->isHOD == 1){ ?>
            <li><a href="<?php echo site_url();?>/performance/hod"><i class="fa fa-circle-o"></i> Performance Evaluation</a></li>
          <?php } ?>
          <?php if($user->isHR == 1){ ?>
            <li><a href="<?php echo site_url();?>/performance/hr"><i class="fa fa-circle-o"></i> Performance Evaluation</a></li>
          <?php } ?>
          <?php if($user->isMD == 1){ ?>
            <li><a href="<?php echo site_url();?>/performance/md"><i class="fa fa-circle-o"></i> Performance Evaluation</a></li>
          <?php } ?>

          <?php if($user->isHOD == 0){ ?>
            <li><a href="<?php echo site_url();?>/appraisal"><i class="fa fa-circle-o"></i> Appraisal</a></li>
          <?php } ?>
          <?php if($user->isHOD == 1){ ?>
            <li><a href="<?php echo site_url();?>/appraisal/hod"><i class="fa fa-circle-o"></i> Appraisal</a></li>
          <?php } ?>
          <?php if($user->isHR == 1){ ?>
            <li><a href="<?php echo site_url();?>/appraisal/hr"><i class="fa fa-circle-o"></i> Appraisal</a></li>
          <?php } ?>
          <?php if($user->isMD == 1){ ?>
            <li><a href="<?php echo site_url();?>/appraisal/hr"><i class="fa fa-circle-o"></i> Appraisal</a></li>
          <?php } ?>
        ...
        <li>
          <a href="http://veritygeo.com/chat">
...
$('.printMe').click(function(){
  ...
  $(".input-id").fileinput({
    ...
    max = currentYear + 0
    var option = "";
    for (var year = currentYear-5 ; year <= max; year++) {
