...
<body class="hold-transition" style="background-image: url('http://veritygeo.com/demo/dashboard/uploads/images/app-images/veritygeo.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center;">
<div class="login-box">
  ...
  <br>
        <div class="row">
            ...
            <div class="col-lg-6" class="text-right">
                <a href="<?php echo site_url();?>/user/ForgetPassword" class="pull-right">Reset Password</a>
            </div>
        </div>
