...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url();?>/procurement">Requisition</a></li>
      ...
      <div class="row">
            ...
            <div class="col-md-12">    
                ...
                <div class="box box-info">
                    ...
                    <h3 class="box-title">Basic Info <span>Approved Requisition VG<?php echo $basic_info->req_ID; ?></span></h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                ...
                <div class="box box-warning">
                    ...
                    <!-- /.box-body -->
                    <!-- /.box-body -->
                    <?php if($basic_info->process_level == 2){ ?>
                        <div class="box-footer">
                            <a href="<?php echo site_url('procurement/MarkedAsProccessed/'.$basic_info->req_ID);?>" class="btn btn-success pull-right" onclick="return confirm('are you sure this item is now available for pickup ?')">Mark As Processed</a>
                        </div>
                    <?php } ?>
                    <!-- /.box-footer -->
                </div>
