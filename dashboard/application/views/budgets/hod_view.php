      ...
      <div class="row">
            ...
            <div class="col-md-12">    
                ...
                <div class="box box-info">
                    ...
                    <h3 class="box-title">Basic Info <span>Pending Budget VG<?php echo $basic_info->budget_ID; ?></span></h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <p class="text-center text-info">BG<?php echo $basic_info->budget_ID; ?></p>
                            </div>
                            <div class="col-lg-4">
                ...
                <div class="box box-warning">
                    ...
                    <?php if($basic_info->process_level == 0){ ?>
                        <div class="box-footer">
                            <a href="<?php echo site_url('Budget/HodReject/'.$basic_info->budget_ID);?>" class="btn btn-danger" onclick="return confirm('are you sure you want to reject this item?')">Reject</a>
                            <a href="<?php echo site_url('Budget/HodRecommend/'.$basic_info->budget_ID);?>" class="btn btn-success pull-right" onclick="return confirm('are you sure you want to recommend this item?')">Recommend</a>
                        </div>
                    <?php } ?>
                    <!-- /.box-footer -->
                </div>
