          ...
          <div class="box" style="border-top: 3px solid red;">
            ...
            <div class="box-body">
              <table class="table table-bordered table-striped datatable">
                ...
                <tbody>
                  <?php foreach($performanceMDPending as $performance){ ?>
                    <tr>
                      ...
                      <td class="text-center"><a href="<?php echo site_url('performance/MDView/'.  $performance->id); ?>"><i class="fa fa-eye fa-lg" style="color:purple;"></i></a></td>
                    </tr>
                  <?php } ?>
                </tbody>
              </table>
          ...
          <div class="box" style="border-top: 3px solid lightblue;">
            ...
            <div class="box-body">
              <table class="table table-bordered table-striped datatable">
                ...
                <tbody>
                  <?php foreach($performanceMDTreated as $performance){ ?>
                    <tr>
                      <td class="text-center"><?php echo $performance->id; ?></td>
                      <td class="text-center"><?php echo $CI->GetUserWithEmail($performance->staff_email); ?></td>
                      <td class="text-center"><?php echo $CI->GetDeptWithDeptID($performance->dept); ?></td>
                      <td class="text-center"><?php echo date('d-m-Y h:ia', strtotime($performance->created_at)); ?></td>
                      <td class="text-center"><a href="<?php echo site_url('performance/MDViewDone/'.  $performance->id); ?>"><i class="fa fa-eye fa-lg" style="color:purple;"></i></a></td>
                    </tr>
                  <?php } ?>
                </tbody>
              </table>
