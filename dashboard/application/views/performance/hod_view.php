      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box" style="border-top: 3px solid orange;">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form action="<?php echo site_url('/Performance/HODUpdate/'. $performance->id);?>" method="POST">
                       <h4><u>SECTION I - Employee Data </u></h4>
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <?php echo date('d-m-Y', strtotime($performance->employ_date)); ?>
                            </td>
                            </tr>
                            <tr>
                          ...
                          <table class="table table-bordered table-condensed">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="leadership_hod" id="" class="form-control" required>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="mgt_skills_hod" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="decision_hod" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="planning_hod" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="business_understanding_hod" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="customer_service_hod" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="interpersonal_hod" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="discipline_hod" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="budget_control_hod" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="communication_hod" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                                <td colspan="4" class="text-center">% Total Assessment Rating<input type="number" name="total_assessment_rating1" id="" required></td>(Total Rating/No of Score40%)
                              </tr>
                            </tbody>
                          </table>
