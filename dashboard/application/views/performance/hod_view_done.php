            ...
            <div class="box-body">
                <form action="<?php echo site_url('Performance/HODUpdate/'. $performance->id);?>" method="POST">
                        ...
                        <h4><u> SECTION II – REVIEW OF STAFF PERFORMANCE</u></h4>
                          ...
                          <table class="table table-bordered table-condensed">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td colspan="4" class="text-center">% Total Assessment Rating : <span class="label label-primary" style="background:#EEEEEE;"> <strong><?php echo $performance->total_assessment_rating1; ?></strong></span>(Total Rating/No of Score40%)</td>
                              </tr>
                            </tbody>
                          </table>
                      ...
                      <h4><strong>  GOALS: REVIEW OF KEY PERFORMANCE AREAS (50%)</strong></h4>
                          ...
                          <p class="text-center">  <strong> Total Assessment Rating:</strong> <span class="label label-primary" style="background:#EEEEEE;"> <strong><?php echo $performance->total_assessment_rating2; ?></span> </strong>  %</p>
                              ...
                              <textarea name="staff_strength" id="" cols="30" rows="3" class="form-control" disabled><?php echo $performance->staff_strength; ?></textarea>
                                ...
                                <textarea name="areas_to_dev" id="" cols="30" rows="3" class="form-control" disabled><?php echo $performance->areas_to_dev; ?></textarea>
                                  ...
                                  <textarea name="recommended_trainings" id="" cols="30" rows="3" class="form-control" disabled><?php echo $performance->recommended_trainings; ?></textarea>
                                    ...
                                    <h5><strong>HOD RECOMMENDATION</strong></h5>
                                     <p class="bg-secondary" style="background:#EEEEEE;">
