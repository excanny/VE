      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box" style="border-top: 3px solid orange;">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form action="<?php echo site_url('/Performance/HRUpdate/'. $performance->id);?>" method="POST">
                          ...
                          <table class="table table-bordered table-condensed">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td width="150"><strong>HOD's PICK</strong></td>
                                <td width="150"><strong>HR's PICK</strong></td>
                              </tr>
                              <tr>
                                <td>1</td>
                                ...
                                <td><?php echo $performance->leadership_hod; ?></td>
                                <td>
                                  <select name="leadership_hr" id="" class="form-control" required>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="mgt_skills_hr" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="decision_hr" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="planning_hr" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="business_understanding_hr" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="customer_service_hr" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="interpersonal_hr" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="discipline_hr" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="budget_control_hr" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select name="communication_hr" id="" class="form-control" required>
                                    <option value="">Select One</option>
                                    <option value="5">5</option>
                                    <option value="4">4</option>
                                    <option value="3">3</option>
                              ...
                              <tr>
                              <td colspan="5" class="text-center">% Total Assessment Rating : <?php echo $performance->total_assessment_rating1; ?>(Total Rating/No of Score40%)</td>
                              </tr>
                            </tbody>
                          </table>
