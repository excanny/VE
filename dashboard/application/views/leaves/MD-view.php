                ...
                <div class="box box-warning">
                    ...
                    <?php if($basic_info->process_level == 1){ ?>
                        <div class="box-footer">
                            <a href="<?php echo site_url('Leave/MDReject/'.$basic_info->id);?>" class="btn btn-danger" onclick="return confirm('are you sure you want to reject this item?')">Reject</a>
                            <a href="<?php echo site_url('Leave/MDApprove/'.$basic_info->id);?>" class="btn btn-success pull-right" onclick="return confirm('are you sure you want to approve this item?')">Approve</a>
                        </div>
                    <?php } ?>
                    <!-- /.box-footer -->
                </div>
